...
describe('ProductService', () => {
  ...
  // // with catchError and handleError - client side
  // it('throws client side error', () => {

  //   const mockError = new ProgressEvent('my error');
  ...
  //   const errorEvent = new ErrorEvent("0",{
  //     colno: 1,
  //     error: "dd",
  //     filename: "ss",
  //     lineno: 1,
  ...
  // // };
  //  //req.flush(errorResponse, { status: 0, statusText: 'Not Found'});
  //  //req.error(new ProgressEvent('error', errorEvent), { status: 0 });
  //  //req.flush("ddd", { status: 0, statusText: 'Not Found' });
  //  req.flush(errorEvent, { status: 0, statusText: 'Not Found'});
  //   //req.error(mockError);
  //   //req.error(new ProgressEvent('error'), { status: 0 });
  // });

  // // with catchError and throw HttpErrorResponse
  // it('throw error using HttpErrorResponse', () => {
  ...
  //       // // console.log("error.error.error: " + JSON.stringify(error.error.error))
  ...
  // it('should get products2',
  //   inject(
  //     [HttpTestingController, ProductService],
  //     (controller2: HttpTestingController, productService2: ProductService) => {

  //       console.log("products4");
  //       productService2.get().subscribe((products) => {
  //         expect(products).toEqual(FAKE_PRODUCTS);
  //       });

  //       const req = controller2.expectOne(() => true);
  ...
  //   req.flush('404 error2', { status: 404, statusText: 'Not Found' });
  // });
  ...
  //     }
  // (nocontent) => {
  //       console.log("nocontent: " + JSON.stringify(nocontent));
  //       console.log("req.request.url: " + req.request.url);
  //       expect(req.request.url.includes('/api/v1/Product/1')).toBeTrue();
  //       expect(req.request.method).toBe('DELETE');
  //       expect(req.error.s).toBe('DELETE');
  //       console.log("headers: " + JSON.stringify(req.request.headers));
  //       expect(nocontent).toEqual("");
  //       // expect(req.request.headers).toBe('DELETE');
  //   });
    // const req = controller.expectOne('/api/v1/Product/1');
