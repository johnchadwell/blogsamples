...
// static versions of OrderMappers.cs

namespace JCOrderInventory.Core.Domain.Mappers
{
    public static class OrderMappers {

        public static OrderResponseDTO OrderDomain_To_OrderResponseDTO(OrderDomain order)
        {
        ...
        public static List<OrderResponseDTO> OrderDomains_To_OrderResponseDTOs(List<OrderDomain> order)
        {
        ...
        public static OrderDomain OrderRequestDTO_To_OrderDomain(OrderRequestDTO order)
        {
        ...
        public static List<OrderDomain> OrderRequestDTOs_To_OrderDomains(List<OrderRequestDTO> order)
        {
        ...
        public static OrderResponseWrapperDTO OrderResponseDTO_To_OrderResponseWrapperDTO(OrderResponseDTO order)
        {
        ...
        public static List<OrderResponseWrapperDTO> OrderResponseDTOs_To_OrderResponseWrapperDTOs(List<OrderResponseDTO> order)
        {
        ...
        public static OrderResponseDTO OrderDomain_To_OrderResponseDTO_using_Mapster(OrderDomain order)
        {
            return order.Adapt<OrderResponseDTO>();
        }

        public static IList<OrderResponseDTO> OrderDomains_To_OrderResponseDTOs_using_Mapster(IList<OrderDomain> orderList)
        {
            var r = orderList.Adapt<IList<OrderResponseDTO>>();
            return r;
        }

        public static OrderResponseWrapperDTO OrderResponseDTO_To_OrderResponseWrapperDTO_using_Mapster(OrderResponseDTO order)
        {
            return order.Adapt<OrderResponseWrapperDTO>();
        }

        public static IList<OrderResponseWrapperDTO> OrderResponseDTOs_To_OrderResponseWrapperDTOs_using_Mapster(IList<OrderResponseDTO> orderList)
        {
